EMPLOYEE_AREAS = {
    '中央エリア': ['佐渡','大塚', '和田', '新門', '大田', '山下', '大久保(祐)','石崎', '栗原', '石田', '米山'],
    '北エリア': ['大久保(あ)','小山'],
    '南薩エリア': ['池端','濱上','尾辻'],
    '宮崎エリア': ['坂元','萩原','高','岩倉','甲斐','宮']
}

# すべての従業員を1つのリストにフラット化
EMPLOYEES = [employee for employees in EMPLOYEE_AREAS.values() for employee in employees]
...
SHIFT_TYPES = ['AM可', 'PM可', '1日可', '時間指定', '-', '休み', '鹿屋', 'かご北', 'リクルート', 'その他']
